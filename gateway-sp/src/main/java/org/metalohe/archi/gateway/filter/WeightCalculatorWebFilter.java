...
import org.metalohe.archi.gateway.event.WeightDefinedEvent;
...
import org.metalohe.archi.gateway.support.WeightConfig;
...
public class WeightCalculatorWebFilter implements WebFilter, Ordered, SmartApplicationListener {
	...
	/* for testing */ static Map<String, String> getWeights(ServerWebExchange exchange) {
		Map<String, String> weights = exchange.getAttribute(ServerWebExchangeUtils.WEIGHT_ATTR);
