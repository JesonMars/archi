...
import org.metalohe.archi.gateway.support.NotFoundException;
...
public class LoadBalancerClientFilter implements GlobalFilter, Ordered {
	...
	protected ServiceInstance choose(ServerWebExchange exchange) {
		return loadBalancer.choose(((URI) exchange.getAttribute(ServerWebExchangeUtils.GATEWAY_REQUEST_URL_ATTR)).getHost());
	}
